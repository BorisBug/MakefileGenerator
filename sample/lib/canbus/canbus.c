...
bool canbus_set_temperature(float value)
{
	...
	if(value>=100 && value<=500)
	{
		...
		buffer_insert(message[0].buf, 0, 10, ui);
	}
...
float canbus_get_temperature(void)
{
	...
	uint64_t ui = buffer_extract(message[0].buf, 0, 10);
...
bool canbus_set_humidity(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[0].buf, 10, 7, value);
	}
...
{
	// return range [0, 100]
	return (uint8_t)buffer_extract(message[0].buf, 10, 7);
}
...
bool canbus_set_dht_sensor_status(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[0].buf, 17, 2, value);
	}
...
uint8_t canbus_get_dht_sensor_status(void)
{
	...
	return (uint8_t)buffer_extract(message[0].buf, 17, 2);
}
...
bool canbus_set_flow_rate(uint16_t value)
{
	...
	{
		result = true;
		buffer_insert(message[0].buf, 19, 9, value);
	}
...
{
	// return range [17, 500]
	return (uint16_t)buffer_extract(message[0].buf, 19, 9);
}
...
bool canbus_set_flow_meter_sensor_status(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[0].buf, 28, 2, value);
	}
...
{
	// return status: 0=ERROR, 1=WARNING, 2=OKAY
	return (uint8_t)buffer_extract(message[0].buf, 28, 2);
}
...
bool canbus_set_light_intensity(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[0].buf, 30, 7, value);
	}
...
{
	// return range [0, 100]
	return (uint8_t)buffer_extract(message[0].buf, 30, 7);
}
...
bool canbus_set_light_intensity_sensor_status(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[0].buf, 37, 2, value);
	}
...
{
	// return status: 0=ERROR, 1=WARNING, 2=OKAY
	return (uint8_t)buffer_extract(message[0].buf, 37, 2);
}
...
bool canbus_set_water_level(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[0].buf, 39, 7, value);
	}
...
{
	// return range [0, 100]
	return (uint8_t)buffer_extract(message[0].buf, 39, 7);
}
...
bool canbus_set_water_level_sensor_status(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[0].buf, 46, 2, value);
	}
...
{
	// return status: 0=ERROR, 1=WARNING, 2=OKAY
	return (uint8_t)buffer_extract(message[0].buf, 46, 2);
}
...
bool canbus_set_soil_moisture(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[0].buf, 48, 7, value);
	}
...
{
	// return range [0, 100]
	return (uint8_t)buffer_extract(message[0].buf, 48, 7);
}
...
bool canbus_set_soil_moisture_sensor_status(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[0].buf, 55, 2, value);
	}
...
{
	// return status: 0=ERROR, 1=WARNING, 2=OKAY
	return (uint8_t)buffer_extract(message[0].buf, 55, 2);
}
...
bool canbus_set_rtc_year(uint16_t value)
{
	...
	{
		result = true;
		buffer_insert(message[1].buf, 0, 11, value);
	}
...
uint16_t canbus_get_rtc_year(void)
{
	...
	return (uint16_t)buffer_extract(message[1].buf, 0, 11);
}
...
bool canbus_set_rtc_month(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[1].buf, 11, 4, value);
	}
...
{
	// return range [1, 12]
	return (uint8_t)buffer_extract(message[1].buf, 11, 4);
}
...
bool canbus_set_rtc_day(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[1].buf, 15, 5, value);
	}
...
{
	// return range [1, 31]
	return (uint8_t)buffer_extract(message[1].buf, 15, 5);
}
...
bool canbus_set_rtc_hour(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[1].buf, 20, 5, value);
	}
...
{
	// return range [0, 23]
	return (uint8_t)buffer_extract(message[1].buf, 20, 5);
}
...
bool canbus_set_rtc_minute(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[1].buf, 25, 6, value);
	}
...
{
	// return range [0, 59]
	return (uint8_t)buffer_extract(message[1].buf, 25, 6);
}
...
bool canbus_set_rtc_second(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[1].buf, 31, 6, value);
	}
...
{
	// return range [0, 59]
	return (uint8_t)buffer_extract(message[1].buf, 31, 6);
}
...
bool canbus_set_rtc_status(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[1].buf, 37, 2, value);
	}
...
{
	// return status: 0=ERROR, 1=WARNING, 2=OKAY
	return (uint8_t)buffer_extract(message[1].buf, 37, 2);
}
...
bool canbus_set_water_pump_state(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[1].buf, 39, 1, value);
	}
...
uint8_t canbus_get_water_pump_state(void)
{
	...
	return (uint8_t)buffer_extract(message[1].buf, 39, 1);
}
...
bool canbus_set_water_pump_status(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[1].buf, 40, 2, value);
	}
...
{
	// return status: 0=ERROR, 1=WARNING, 2=OKAY
	return (uint8_t)buffer_extract(message[1].buf, 40, 2);
}
...
bool canbus_set_water_valve_state(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[1].buf, 42, 1, value);
	}
...
{
	// return states: 0=OFF, 1=ON
	return (uint8_t)buffer_extract(message[1].buf, 42, 1);
}
...
bool canbus_set_water_valve_status(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[1].buf, 43, 2, value);
	}
...
{
	// return status: 0=ERROR, 1=WARNING, 2=OKAY
	return (uint8_t)buffer_extract(message[1].buf, 43, 2);
}
...
bool canbus_set_fans_state(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[1].buf, 45, 1, value);
	}
...
{
	// return states: 0=OFF, 1=ON
	return (uint8_t)buffer_extract(message[1].buf, 45, 1);
}
...
bool canbus_set_fans_status(uint8_t value)
{
	...
	{
		result = true;
		buffer_insert(message[1].buf, 46, 2, value);
	}
...
{
	// return status: 0=ERROR, 1=WARNING, 2=OKAY
	return (uint8_t)buffer_extract(message[1].buf, 46, 2);
}
